...
void protobuf_AddDesc_gcsdk_5fgcmessages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ectionStatus_NO_STEAM\020\004B\005H\001\200\001\000", 5710);
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CMsgAccountDetails*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(valid_, free_trial_account_);
    if (has_account_name()) {
      if (account_name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        account_name_->clear();
      }
  ...
  if (_has_bits_[8 / 32] & 65280) {
    ZR_(subscribed_, community_banned_);
  }
  ZR_(trade_banned_, eligible_for_community_market_);
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CMsgGCMultiplexMessage*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CGCToGCMsgMasterAck*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CGCToGCMsgRouted*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CMsgGCUpdateSessionIP*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 253) {
    ZR_(version_, partner_accountbalance_);
  }
  steam_launcher_ = 0u;
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CMsgServerHello*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 125) {
    ZR_(version_, legacy_client_session_need_);
    ZR_(client_launcher_, required_internal_addr_);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 243) {
    ZR_(version_, rtime32_gc_welcome_timestamp_);
    if (has_game_data()) {
      if (game_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        game_data_->clear();
      }
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 7) {
    ZR_(gameitemid_, one_per_account_);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 115) {
    ZR_(appid_, gameitemid_);
    ZR_(validate_only_, make_workshop_files_subscribable_);
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CGameServers_AggregationQuery_Response_Group*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 126) {
    ZR_(servers_empty_, player_capacity_);
  }
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CWorkshop_AddSpecialPayment_Request*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 31) {
    ZR_(appid_, gameitemid_);
    ZR_(payment_us_usd_, payment_row_usd_);
    if (has_date()) {
      if (date_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        date_->clear();
      }
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CProductInfo_SetRichPresenceLocalization_Request*>(16)->f) - \
   reinterpret_cast<char*>(16))
